...
*
* newPet NewPet Pet to add to the store
* returns Pet
* */
const addPet = ({ newPet }) => new Promise(
...
* */
const deletePet = ({ id }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        id,
...
* returns Pet
* */
const find pet by id = ({ id }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        id,
...
* returns List
* */
const findPets = ({ tags, limit }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        tags,
